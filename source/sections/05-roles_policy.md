...
The current Onyx Privacy Officer is Travis Good ([travis@onyx.supplies](mailto:travis@onyx.supplies)).
...
The current Onyx Security Officer is Ryan Rich ([ryan@onyx.supplies](mailto:ryan@onyx.supplies)).
